...
namespace vertagt
{
	...
	public:
		// Benötigt man einen Standardkonstruktor? nein
	...
	// PushFront
	template <class T> class VPushFront : public VAktion<T>
		{
			private:
				T p_objekt;
	...
	public:
		...
		void vAusfuehren() override
		{
			VAktion<T>::p_pListe.erase(p_it); //loeschen objektes aus der liste
		}
	};
}  // namespace vertagt
